...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-transaction.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-transaction-chain.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-transaction-keys.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-multiple-outputs.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-change.pdf}
    \caption{Alice uses her salary, the incoming edge, in a single transaction to pay for
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-change-chain.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-multiple-inputs.pdf}
...
Each transaction is given an \emph{identifier} known as the \emph{$\txid$}~\index{txid}%
. This is
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-outpoint.pdf}
...
\emph{transaction ledger}\index{Ledger}. In Figure~\ref{fig.utxo-tx-graph}, transactions are labeled
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-tx-graph.pdf}
...
a payment, they create a new transaction and broadcast it to the network. This transaction is
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.65 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-sig.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65 \columnwidth,keepaspectratio]{03-utxo/figures/utxo-sig-multi.pdf}
    \caption{Alice creates a new transaction, transaction $19$, by which she pays Bob
             $8$ units
             and Charlie $2$ units.
             The transaction data include Bob's public key, Charlie's public key,
...
\section{Transaction Validation}\label{sec.transaction.validation}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7 \linewidth]{03-utxo/figures/utxo-tx-graph-2.pdf}
