...
% There's a space between confirmed and the period
\emph{confirmed}~\index{Confirmation}. When an honest party invokes the \emph{read} functionality
...
is illustrated in Algorithm~\ref{alg.mine-block}.
