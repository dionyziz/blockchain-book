...
Of course, if a transaction is delayed while in transit on the network \emph{forever}, some nodes
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6 \columnwidth,keepaspectratio]{04-block/figures/double-spend.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4 \columnwidth,keepaspectratio]{04-block/figures/simple-idea-1.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.325 \columnwidth,keepaspectratio]{04-block/figures/simple-idea-2.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45 \columnwidth,keepaspectratio]{04-block/figures/simple-idea-3.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65 \columnwidth,keepaspectratio]{04-block/figures/wallet-fullnode-architecture.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8 \columnwidth,keepaspectratio]{04-block/figures/time-tickets.pdf}
...
\import{./04-block/}{algorithms/alg.proof-of-work}
...
A natural question now arises: If we've bundled multiple transactions together into one block,
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5 \columnwidth,keepaspectratio]{04-block/figures/block.pdf}
...
\emph{confirmed}. When an honest party invokes the \emph{read} functionality
...
changed to point to a newer block to make $B$ appear fresh. The final proof-of-work algorithm
...
\import{./04-block/}{algorithms/alg.mine-block}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1 \columnwidth,keepaspectratio]{04-block/figures/the-chain.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7 \columnwidth,keepaspectratio]{04-block/figures/genesis-chain.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1 \columnwidth,keepaspectratio]{04-block/figures/thetimes.jpg}
