...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.7 \columnwidth,keepaspectratio]{figures/blocktree-problem-6.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7 \columnwidth,keepaspectratio]{figures/tx-graph-problem-6.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7 \columnwidth,keepaspectratio]{figures/timeline-problem-6.pdf}
