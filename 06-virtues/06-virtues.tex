...
at the same point in time, and we \emph{chop off} $k$ blocks from the end of the chain 
of one party, we get a \emph{prefix} of the chain of the other party. In other
