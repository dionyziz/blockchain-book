...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth,keepaspectratio]{08-economics/figures/rational-model.pdf}
...
which is an expensive endeavor. Therefore, miners need to be incentived to
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth,keepaspectratio]{08-economics/figures/reward_halving.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8 \columnwidth,keepaspectratio]{08-economics/figures/macroeconomics.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8 \columnwidth,keepaspectratio]{08-economics/figures/rational-miner-txs.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4 \columnwidth,keepaspectratio]{08-economics/figures/replace-by-fee.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7 \columnwidth,keepaspectratio]{08-economics/figures/trezor-tx.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7 \columnwidth,keepaspectratio]{08-economics/figures/ledger-pin.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth,keepaspectratio]{08-economics/figures/bitcoin-hashrate.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8 \columnwidth,keepaspectratio]{08-economics/figures/pow-epochs.pdf}
...
\begin{enumerate}
  \item For all $i$, check that $\chain[i].r < \chain[i + 1].r$, i.e. timestamps are increasing.
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[scale = 0.5]{08-economics/figures/hardware.png}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[scale = 0.1]{08-economics/figures/hardware_wallet.jpg}
...
when payouts consists only of fees and no or low block rewards, this belief is actually
...
Difficulty}~\cite{varbackbone}. The reliability and importance of chain
timestamps is discussed in detail in the paper \emph{On-Chain Timestamps
are Accurate}~\cite{timeliness}.
