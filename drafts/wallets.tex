...
when they are buried sufficiently deeply within the chain. When the user issues
...
network so that it can be included in the blockchain and eventually verified by the recipient
...
such pairs. In fact, the wallet may decide to generate a new private and public key pair occasionally,
